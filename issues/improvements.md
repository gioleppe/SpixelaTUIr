...
### 1. Undo / Redo for pipeline edits
...
### 3. Preview resolution label in status bar
...
### 5. Confirm-before-quit when there are unsaved changes
...
### 11. Side-by-side before/after split view
...
### 12. Per-effect enable/disable toggle
